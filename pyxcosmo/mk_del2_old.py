##########
#---------------------- Dedicated Function: vv mk_del2  -----------------------

from icosmo_cosmo import xgen

from icosmo_cosmo import del2_lin
import math
import numpy as np
import scipy
from icosmo_cosmo import extrap1d

from icosmo_cosmo import *  #### ??? to remove

#import pdb
from fitsutils import mrdfits

def mk_del2(cosmo, z, kl_ran=[.01,10.], n_k=100, fit_nl=False, gtype='ODE', fit_tk=False):
...
; INPUT: cosmo: cosmological parameter structure
;        z redshift vector
; OPTIONAL INPUT: kl_ran: range of linear k values to consider [h Mpc^-1]
;                         (h-corrected physical units; default=
;                         [.01,100.] h Mpc^-1). Note that the non-linear
...
;                         to use: 0: Peacock and Dodds,
;                                 1: Ma et al., 2: Smith et al.
; OUTPUT: del2 structure containing:
