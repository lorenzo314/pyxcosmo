...
Contains:
 ...
 - mwrfits
    ...
    RG  27 May 2015  byte array whose size is one are not converted in arry
           byte array whose size are greater than one are converted, 
           even if its is na image,  version 3
           beware in version 2, a byte variable was converted in string, 
           like cosmo['NORM']
    RG 15 May 2015  strings stored as byte arrays and scalar converted 
       to numpy array, version 2
    RG 13 March 2015  has_key  version 1
    RG Ven 25 sep 2015 replace pyfits by astropy.io.fits
    RG Ven 18 mar 2016 mwrfits now have append keyword
                 header.update
"""
